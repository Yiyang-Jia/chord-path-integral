...
decreasingkappamesh=linspace(-0.5, 0.5, 181);% note for decreasing k solutions, initial mesh size can be important
...
%  solinitk1 = bvpinit(xmesh, @exactk1);
solinitk1 = bvpinit(xmesh, [-0.01;0;-50;0]); %Actually this is better guess for lz ~=0 and <<1 
